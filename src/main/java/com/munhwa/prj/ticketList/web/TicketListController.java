...
public class TicketListController {
	...
	public String ticketListInsert(HttpSession session,int id) {
...
//		vo.setMemberId(session.getAttribute("member"));
	...
	private String makeQR(HttpServletRequest req, @PathVariable("fileName") String fileName) throws WriterException, IOException {
		String qrURI = null;
	    ...
	    try (DatagramSocket r = new DatagramSocket()){
	    	...
	    	qrURI = r.getLocalAddress().getHostAddress()+t;
	    ...
	    String storefileName = makeQRDetail(path, qrURI, fileName);
		return null;
	}
