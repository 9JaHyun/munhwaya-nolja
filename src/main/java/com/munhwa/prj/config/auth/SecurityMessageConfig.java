...
public class SecurityMessageConfig {
  ...
  public MessageSource messageSource() {
    ...
    messageSource.setBasenames("classpath:security_message", "classpath:org/springframework/security/messages"); // 커스텀한 properties 파일, security properties 파일 순서대로 설정
