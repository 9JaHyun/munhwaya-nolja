...
<div align="right" style="margin-bottom: 50px;">
	...
	<div style="float:left; margin-right:30px;"><a href="" class="tbutton small"><span>곡 구매 내역</span></a></div> 
	<div style="float:left; margin-right:30px;"><a href="usageHistoryOfPerformance.do" class="tbutton small"><span>공연 티켓 구매 내역</span></a></div> 
