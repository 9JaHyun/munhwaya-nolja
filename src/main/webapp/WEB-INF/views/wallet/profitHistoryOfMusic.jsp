...
<div align="right" style="margin-bottom: 50px;">
	...
	<div style="float: right;">
		<div style="float: left; margin-right: 70px;">
			<a href="" class="tbutton small"><span>곡 수익 내역</span></a>
		</div>
		<div style="float: left; margin-right: 70px;">
			<a href="profitHistoryOfPerformance.do" class="tbutton small"><span>공연
					수익 내역</span></a>
		</div>
...
<form id="moveForm" method="get" action="profitHistoryOfMusic.do">
...
<script>
	...
	function selChange() {
		...
		location.href="profitHistoryOfMusic.do?pageNum=1&amount="+sel+"&startDate="+startDate+"&endDate="+endDate;
	}
