    ...
    <div class="row row-fluid clearfix mbf">
        <div class="def-block">
            ...
            <form id="dto" action="posting" method="post" enctype="multipart/form-data">
                <h4>제목</h4>
                <input type="text" id="title" name="title" style="width: 100%" value="${post.title}">
                <div style="margin-bottom: 30px">
                <textarea name="content" style="width: 100%; height: 500px" placeholder="수정할 내용을 입력하세요"></textarea>
                </div>
