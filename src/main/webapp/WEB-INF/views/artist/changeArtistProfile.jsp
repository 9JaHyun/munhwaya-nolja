...
<div align="right" style="margin-bottom: 30px;">
    ...
    <form method="post" id="frm" action="changeArtistProfile"
        ...
        <div align="center" style="margin: 20px 0px 100px 0px;">
            ...
            <div class="sort"
                 style="font-size: 14px; color: white; padding: 0.5em; margin-top:3em;">활동명&emsp;
            </div>
            ...
            <ul>
                ...
                <label style="font-size: 15px; color: white; padding: 0.5em; margin-top:2.5em;"><
                    활동정보 선택 ></label>

                <label style="font-size: 14px; color: white; padding: 0.5em;">성별<br> <select
                        id="gender" name="gender"></label>
                <!-- select box 수직 정렬 -->
                <option>선택</option>
                ...
                <label style="font-size: 14px; color: white; padding: 0.5em;">활동유형<br> <select
            ...
            <br> <label style="font-size: 14px; color: white; padding: 0.5em;">주요활동 장르<br> <select
                id="genre"
                name="genre"></label>
            ...
            <label style="font-size: 14px; color: white; padding: 0.7em;">소개글<br> <textarea
                    id="content" name="content" placeholder="내용을 입력해 주세요."
                    style="width:55%; height:100px;">${artist.content }</textarea>
            </label>
        </div>
    </form>
    <div align="right" style="margin-top:-5em;">
        <button style="padding: 0.3em 1em 0.3em 1em; margin: 1em 0.3em 0 0.3em;"
                class="tbutton small" onclick="send()">수정
        </button>
        <button style="padding: 0.3em 1em 0.3em 1em; margin: 1em 0.3em 0 0.3em;"
                onclick="location.href='memberChangeInfo.do'" class="tbutton small">취소
        </button>
    </div>
