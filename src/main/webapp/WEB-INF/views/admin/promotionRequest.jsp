		...
		<div class="row row-fluid clearfix mbf" style="padding-bottom:100px;">
			<div class="span7 posts">
				<div class="def-block" style="width: 100%;">
					<h4 style="border-bottom: none;">아티스트 승급 신청</h4>
						...
						<div class="grid_12" style="width: 100%;">
							<div class="mbf clearfix">
								<table class="table">
									<thead>
										<tr>
											<th scope="col" style="font-size: 13pt;">회원ID</th>
											<th scope="col" style="font-size: 13pt;">신청일</th>
											<th scope="col" style="font-size: 13pt;">처리상태</th>
											<th scope="col" style="font-size: 13pt;">수정일</th>
										</tr>
									</thead>
									<tbody>
				...
				<div class="def-block widget">
					...
					<div class="widget-content">
                        ...
                        <div style="text-align: center; width: 100%" >
                            <button type="button" class="btn btn-success" id="approveBtn" name="update_cart" onclick="payCart()">승인</button>
                            <button type="button" class="btn btn-danger" id="rejectBtn" name="update_cart" onclick="payCart()">거절</button>
                        </div>
