            ...
            <ul class="list" style="font-size: 13px;">
                ...
                <c:choose>
                    <c:when test="${member.role == 'R01'}">
                        ...
                        <li><a href="artistRequestForm.do"><i class="icon-caret-right"> </i>아티스트 신청</a></li>
                    </c:when>
                    <c:otherwise>
                        <li><a href="artistManagement.do"><i class="icon-caret-right"> </i>아티스트 관리</a></li>
                        <li><a href="artistInsertForm"><i class="icon-caret-right"></i>아티스트 정보등록</a></li>
                    </c:otherwise>
                </c:choose>
            </ul>
        </div>
