                ...
                <c:choose>
                    ...
                    <c:otherwise>
                        ...
                        <div align="right" style="margin: 20px 0px 10px 0px;">
                            <div style="font-size:12px; color:white;">보유 마일리지 : <a
                                    id="sidebarMileage">${member.mileage}</a></div>
                        </div>
                        <!-- 충전버튼 -->
                        <div align="right">
        ...
        <div class="widget-content">
            <ul class="list">
                <c:choose>
                    ...
                    <c:when test="${member.role == 'R03' }">
                        <li><a href="${rootPath}/judgeArtist"><i class="icon-caret-right"> </i>아티스트
                            승급
                            관리</a></li>
                        <li><a href="${rootPath}/performanceList"><i class="icon-caret-right"> </i>아티스트
                            공연 관리</a></li>
                    </c:when>
                </c:choose>
            </ul>
