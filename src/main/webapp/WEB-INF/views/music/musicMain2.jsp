				...
				<div class="span4 sidebar">
					...
					<a href="chart">
						...
						<div class="widget-content row-fluid">
							<ul class="tab-content-items">
								<li>
									<a class="m-thumbnail" href="mp3_single_half.html"><img width="50" height="50" src="resources/images/bg/musicBg3.jpg" alt="#"></a>
							...
							<ul class="tab-content-items">
								<li>
									<a class="m-thumbnail" href="mp3_single_half.html">
										<img width="50" height="50" src="resources/images/bg/musicBg3.jpg" alt="#">
									</a>
									<h3>
