                        ...
                        <div class="video-grid">
                            <a href="albumInfo?id=${AlbumSelectByMusicId.id }" class="grid_3">
                                <img src="api/picture/${AlbumSelectByMusicId.picture }" alt="#"
                                     style="max-width:180px; min-width:180px; max-height :180px; min-height:180px;">
    ...
    <div class="modal-dialog ">
        <div class="modal-content ">
            ...
            <div class="modal-footer def-block">
                <button class="tbutton small" data-toggle="modal" data-target="#myModal2"
                        data-dismiss="modal" aria-label="Close"><span>위시리스트 생성</span></button>
...
<!-- 위시리스트모달 끝-->
<!-- 위시리스트 추가모달 -->
<div class="modal fade def-block" id="myModal2" tabindex="-1" role="dialog"
     aria-labelledby="myModalLabel" aria-hidden="true" style="top:30%; display:none;">
    <div class="modal-dialog ">
        <div class="modal-content ">
            <div class="modal-header">
            ...
            <div class="modal-footer def-block">
                <button type="submit" class="tbutton small" onclick="createWishList()">
                    <span>생성</span></button>
            </div>
        </div>
    </div>
